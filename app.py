...
print_separator()
print("        TELESURGERY AI WORKFLOW EXECUTION REPORT")
print_separator()

print(f"Execution Time : {datetime.now().strftime('%d-%m-%Y %H:%M:%S')}")
print(f"Patient ID     : {doctor.patient_id}")
...
print(f"Diagnosis              : {doctor.diagnosis}")
print(f"Recommended Surgery    : {doctor.recommended_surgery}")
print(f"Urgency                : {doctor.urgency}")
print(f"Risk Level             : {doctor.risk_level}")
print(f"Confidence             : {doctor.confidence}")
...
print(f"Attack Detected        : {security.attack_detected}")
print(f"Attack Type            : {security.attack_type}")
...
print_subseparator()
print("PROTOCOL SWITCHER")
print_subseparator()

print(f"Selected Protocol      : {protocol.protocol}")
...
print(f"Decision               : {feedback.action}")
print(f"Proceed                : {feedback.proceed}")
...
print(f"Action                 : {robot.action}")
print(f"Message                : {robot.message}")
